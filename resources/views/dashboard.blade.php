...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function updateUrlTable(urls) {
            const template = document.getElementById('url-template').innerHTML;
    ...
    {{#urls}}
        <tr>
            ...
            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 dark:text-gray-100">
                <div>{{page_title}}</div>
                <div class="text-[10px] text-gray-500 dark:text-gray-400">{{page_url}}</div>
            </td>
            ...
            <td class="px-6 py-4 whitespace-nowrap text-sm">
                ...
                <a href="{{page_url}}" target="_blank" class="inline-block ml-2 text-blue-600 hover:text-blue-800">
