<section id="url-list" class="pt-8 pb-8 max-w-7xl mx-auto sm:px-6 lg:px-8">
    <!-- Domain Selector -->
    <div id="domain-selector" class="relative inline-block w-1/4">
        <form id="domain-form" method="GET" action="{{ route('admin.urls') }}">
            ...
            <div id="dropdown-menu" class="absolute mt-1 w-full rounded-md bg-white dark:bg-gray-800 shadow-lg z-10 hidden">
                <!-- Search Input -->
                <input id="search-input" class="block w-full px-4 py-2 text-gray-800 border rounded-md border-gray-300 focus:outline-none" type="text" placeholder="Search domains" autocomplete="off">
                <!-- Domain List -->
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Handle domain selection and form submission
        ...
        // Filter domains in the dropdown menu
